...
save_fig(p1a, "outputs/figures/fig1a_rhat_ecdf.png", w = 9, h = 3.2)
save_fig(p1b, "outputs/figures/fig1b_ess_ridges.png", w = 9, h = 3.2)
save_fig(p2, "outputs/figures/fig2_coverage.png", w = 10, h = 6)
save_fig(p3_bias, "outputs/figures/fig3a_bias.png", w = 9, h = 6)
save_fig(p3_rmse, "outputs/figures/fig3b_rmse.png", w = 9, h = 6)
save_fig(p4, "outputs/figures/fig4_ess_per_sec.png", w = 9, h = 3.2)
save_fig(p5, "outputs/figures/fig5_runtime.png", w = 10, h = 6)
save_fig(p7, "outputs/figures/fig7_means_agreement.png", w = 9, h = 6)
save_fig(p_ci, "outputs/figures/figA1_cis_vs_truth.png", w = 11, h = 7)
save_fig(p_ci_matrix, "outputs/figures/figA2_ci_matrix.png", w = 10, h = 12)
save_fig(
  p_precision_tradeoff,
  "outputs/figures/figB1_precision_tradeoff.png",
  w = 10,
  h = 6
)
save_fig(
  p_coverage_heatmap,
  "outputs/figures/figB2_coverage_bias_heatmap.png",
  w = 10,
  h = 5
)
save_fig(
  p_ci_width_violin,
  "outputs/figures/figB3_ci_width_violin.png",
  w = 9,
  h = 6
)
