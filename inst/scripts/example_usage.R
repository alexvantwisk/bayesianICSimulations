...
# Save plot
ggsave(
  filename = "outputs/figures/example_survival_single_cell.png",
  plot = p_surv,
  width = 10,
  height = 6,
  dpi = 300
...
message("Saved survival plot to: outputs/figures/example_survival_single_cell.png")
...
if (length(results_list) > 0) {
  ...
  # Save faceted plot
  ggsave(
    filename = "outputs/figures/example_faceted_panels.png",
    plot = p_facet,
    width = 12,
    height = 8,
    dpi = 300
  ...
  message("\nSaved faceted plot to: outputs/figures/example_faceted_panels.png")
} else {
...
if (length(results_by_weight) > 0) {
  ...
  if (requireNamespace("patchwork", quietly = TRUE)) {
    ...
    ggsave(
      filename = "outputs/figures/example_weight_comparison.png",
      plot = p_combined,
      width = 15,
      height = 5,
      dpi = 300
    ...
    message("Saved weight comparison to: outputs/figures/example_weight_comparison.png")
  }
}
...
message("\nGenerated plots:")
message("  1. outputs/figures/example_survival_single_cell.png")
message("  2. outputs/figures/example_faceted_panels.png")
message("  3. outputs/figures/example_weight_comparison.png")
