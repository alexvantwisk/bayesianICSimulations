...
mkdir -p results/n200/hmc/{summaries,diagnostics}
mkdir -p results/n200/mh/{summaries,diagnostics}
mkdir -p results/n2000/hmc/{summaries,diagnostics}
mkdir -p results/n2000/mh/{summaries,diagnostics}
mkdir -p results/n10000/hmc/{summaries,diagnostics}
mkdir -p results/n10000/mh/{summaries,diagnostics}
mkdir -p logs
